...
public abstract class Employee { // parent abstract class doesn´t create any objects
    ...
    public abstract void work(); // it can be only created in Abstract class or in interface // must be overridden
