...
public class RemoveElements {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            //  element
            if(list.get(i) <  4){
                list.remove(i); // do not use the method in the loop
            }

        }

        System.out.println(list); // [2, 4, 5, 6, 7, 2, 4, 5, 6, 7] shifts to the left
        ...
        list2.removeIf( p -> p < 4); // p is variable, it represents each element of the list
