...
public class ArrayListPractice {
    ...
    public static void main(String[] args) {
        ...
        //   DataType is Employee , each is Employee obj
        ...
        for (Employee eachEmployeeObject : employees) {
            ...
            if (eachEmployeeObject.jobTitle.equals("Java Developer")){ // if the job title of the employee is Java Developer
                System.out.println(eachEmployeeObject.name);// prints the name of the employee
            }
