...
public class StudentsGroup { // StudentsGroup HAS A Student
    ...
    public void addStudent(Student student){ // student object, it takes one student object, and adds it to the arrayList of students
        students.add(student);
    }

    public void addStudent(Student[] students){
        this.students.addAll(Arrays.asList(students));
    }// takes one array of students, and adss the array of the students to the arraylist of students
    ...
    }// takes name,age,gender,id of the student info, creates student object by using the given info, then adds the student object to the arrayList of students

    // id is for each Student unique
