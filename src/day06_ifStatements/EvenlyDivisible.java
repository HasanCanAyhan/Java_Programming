...
public class EvenlyDivisible {
    ...
    public static void main(String[] args) {
        ...
        boolean isDivisibleBy2 = number % 2 == 0;
            // if  the remainder of the number divide by 2 is equal to zero, then it´s evenly divisible by 2.

        boolean isDivisibleBy3 = number % 3 == 0;
           // if  the remainder of the number divide by 3 is equal to zero, then it´s evenly divisible by 3.
       ...
       /*
        ...
        boolean isDivisibleBy6 = number % 6 == 0;
          // if  the remainder of the number divide by 6 is equal to zero, then it´s evenly divisible by 6.
...
3. Create a class named EvenlyDivisible, and write a program that can check if a number is evenly divisible by 2, 3, 5
            ...
            output:
                ...
                EvenlyDivisible means Remainder is zero
