...
public class CydeoLogIn {
    ...
    public static void main(String[] args) {
        ...
        if (u.equals("Cydeo")  && p.equals("WoodenSpoon") ){ // if the credentials are correct
            ...
            if( ! (u.equals("Cydeo")  &&  p.equals("WoodenSpoon")) ){ // after all 3 attempts . if the username and password are still incorrect
    ...
    public static void cydeoLogin(String username, String pasword){
        if (username.equals("Cydeo") && pasword.equals("WoodenSpoon")){
            System.out.println("Logged in");
        }else{
