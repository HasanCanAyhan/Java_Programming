...
public  class Tesla extends Car {
    ...
    public void setPrice(double price) {
        ...
        super.setPrice(price); // call the methods from Parent - Car Class
    }
...
/*
  5. Tesla
	                ...
	                Extra Conditions for the variables:
	                    1. Model of tesla can only be set to one of the followings: -->> setModel
	                        {"Model S", "Model Y", "Model x", "Model 3" };
	                    2. color of tesla can only be set to one of the followings: -->> setColor
	                        {"White", "Red", "Black", "Silver", "Blue", "Brown", "Green"}
	                    3. year of the tesla can not be less than 2008 -->> setYear
	                    4. price of tesla can not be less than 50k -->> setPrice
 */