...
public class NetIncomeCalc {
    ...
    public static void main(String[] args) {
        ...
        if (salary >= 130000){ // if the sakary is 130k or more then the  tax rate should be %35
            taxRate = 0.35;
        }
        ...
        if (salary >= 80000 && salary < 100000 ){ // if the salary is between 80k to 180k (excluded) then the tax rate should be %25
            taxRate = 0.25;
        }
        ...
        double netIncome1 = salary - totalTax;
