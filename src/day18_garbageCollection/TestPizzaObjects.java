...
public class TestPizzaObjects {
    ...
    public static void main(String[] args) {
        ...
        // Class Name object = new Constructor-Class name()

        Pizza pizza1 = new Pizza();
        //     this variable for storing this object "new Pizza()"
        ...
        System.out.println(pizza1); // without toString method we will receive "Hashcode"
