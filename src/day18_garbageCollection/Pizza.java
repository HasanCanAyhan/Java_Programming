...
public class Pizza {
    ...
    // Instance Variable - multiply copies

    public char size; // this is orginal size
    public int numberOfCheeseTopping,numberOfPepperoniTopping;

    // It refers directly the instance variable .
    // We dont need to have any parameter for the CalcCost() method.Because of that we dont need to write "this."
    ...
    //               those are Local variable and  by means of "this." we can convert to "Instance variable"
    public void setInfo(char size,int numberOfCheeseTopping, int numberOfPepperoniTopping  ){
        this.size = size;
        this.numberOfCheeseTopping = numberOfCheeseTopping;
        this.numberOfPepperoniTopping = numberOfPepperoniTopping;
        // orginal                    =    local variable
    }
